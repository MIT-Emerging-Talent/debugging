...
list_4 = [0, -1, 1, -2, 2, -333, 333]
slowsort(list_4)
print(list_4)

list_5 = [10203, 33243, 543, 213, 786, 12454]
slowsort(list_5)
print(list_5)


# adapted from TheAlgorithms/Python:
# https://github.com/TheAlgorithms/Python/blob/99f3a0e4c9b1a6d9ff5bba2adf65d90d55f2250a/sorts/slowsort.py
