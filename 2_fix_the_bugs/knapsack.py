...
#  https://github.com/TheAlgorithms/Python/tree/99f3a0e4c9b1a6d9ff5bba2adf65d90d55f2250a/knapsack
...
# !!! --- there are 2 mistakes added to this function, each one is a small --- !!!
...
if __name__ == "__main__":
    ...
    # Function Call
    max_profit = calc_profit(profit, weight, max_weight)
